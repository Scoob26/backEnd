...
//let jogadores  = [
  let jogadores = [
    { id: 1, nome: "Lionel Messi", posicao: "Atacante", time: "Paris Saint-Germain" },
    { id: 2, nome: "Cristiano Ronaldo", posicao: "Atacante", time: "Al-Nassr" },
    { id: 3, nome: "Neymar Jr.", posicao: "Atacante", time: "Paris Saint-Germain" },
    { id: 4, nome: "Kylian Mbappé", posicao: "Atacante", time: "Paris Saint-Germain" },
    { id: 5, nome: "Kevin De Bruyne", posicao: "Meio-Campo", time: "Manchester City" },
    { id: 6, nome: "Virgil van Dijk", posicao: "Zagueiro", time: "Liverpool" },
    { id: 7, nome: "Alisson Becker", posicao: "Goleiro", time: "Liverpool" },
    { id: 8, nome: "Sergio Ramos", posicao: "Zagueiro", time: "Paris Saint-Germain" },
    { id: 9, nome: "Robert Lewandowski", posicao: "Atacante", time: "Barcelona" },
    { id: 10, nome: "Luka Modrić", posicao: "Meio-Campo", time: "Real Madrid" }
  ];
...
// Rota para obter servidor por ID (protegida por autenticação)
app.get('/jogadores/listarjogadores/:id', authenticate, (req, res) => {
  ...
  if (servidor) {
    ...
    res.status(404).send('jogadores não encontrado'); // Responde com status 404 se o servidor não for encontrado
  }
});
...
// Rota para receber campos da lista de jogadores  no corpo da requisição
app.post('/sua-rota', (req, res) => {
  ...
  // Por exemplo, você pode adicioná-los à sua lista de jogadores 
  jogadores .push({ id, nome, cargo, departamento });
